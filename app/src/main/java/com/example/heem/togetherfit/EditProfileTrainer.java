...
public class EditProfileTrainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newCertId = (EditText) findViewById(R.id.newCertId);
        newCertOrgan = (EditText) findViewById(R.id.newCertOrgan);
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                certID = dataSnapshot.child(currentUId).child("CerID").getValue().toString();
                certOrgan = dataSnapshot.child(currentUId).child("OrganName").getValue().toString();

                userInfo = "Trainer" + "\n" + "Name: " + username + "\n" + "Email: " + email + "\n" + "Age: " + age + "\n" + "Fitness Type: " + fitnesstype + "\n" + "Location: " + userAddress + " "
                        + city + " " + userState + " " + zipcode + "\n" + "Certification ID: " + certID + "\n" + "Certification Organization: " + certOrgan;
            }
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EditProfileTrainer.this, TrainerDashboard.class);
                //start the activity
        ...
        showInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EditProfileTrainer.this, ProfileData.class);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String newID = newCertId.getText().toString();
                String newOrgan = newCertOrgan.getText().toString();

                if(!newOrgan.equals("")) {
                    FirebaseDatabase.getInstance().getReference().child("User").child(currentUId).child("OrganName").setValue(newOrgan);
                }
                ...
                if( !TextUtils.isEmpty(newID)){
                    FirebaseDatabase.getInstance().getReference().child("User").child(currentUId).child("CerID").setValue(newID);
                }
