...
/**
 * Created by Heem on 12/9/16.
 */

public class CustomListForCurrentFriends extends ArrayAdapter<String> {
    ...
    public CustomListForCurrentFriends(Activity context, ArrayList<String> UserName,
                                   ArrayList<String> Image,  ArrayList<String> FitnessType,
                                   ArrayList<String> UserType) {
        super(context, R.layout.activity_current_friends, UserName);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.current_user_info, null, true);
